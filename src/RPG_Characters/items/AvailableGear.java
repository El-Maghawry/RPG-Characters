...
public class AvailableGear {
    ...
    public static String showAvailableWarriorGear(){
        return  "Bronze Helm – Level 1 Required" +
                "\nBronze Plate-body – Level 1 Required"+
                "\nBronze Plate-legs – Level 1 Required"+
                "\nBronze Sword – Level 1 Required"+
                "\nBronze Axe – Level 1 Required"+
                "\nBronze Hammer – Level 1 Required";
    ...
    public static String showAvailableRangerGear(){
        return  "Coif – Level 1 Required" +
                ...
                "\nShort Oak Bow – Level 1 Required";
